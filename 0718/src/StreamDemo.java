/*
 ...
 4. 연산의 결과가 Stream으로 리턴되면 중간 연산이라고 한다. 
 	 반면, 연산의 결과가 Stream이 아닌 형태로 나타나면 최종 연산이라고 한다.
 5. 중간 연산의 결과가 Stream으로 리턴이 되기 때문에, Stream 연산을 계속 이어서 chain 형태로 이용할 수 있다. 
 6. But, 최종 연산의 결과는 Stream이 아니기 때문에 일단 최종 연산을 수행하면 다시 다른 Stream연산을 수행할 수 없다.
 7. Stream연산은 원본의 데이터를 읽어서 기능을 수행하지만, 그 내용을 변경하진 않는다.
...
public class StreamDemo {
	public static void main(String[] args) {
		//Stream생성 : 배열을 이용할 것인가, 아니면 collection을 이용할 것인가에 따라 생성방법이 약간 다르다. 
		//배열로부터 Stream 생성하기 
